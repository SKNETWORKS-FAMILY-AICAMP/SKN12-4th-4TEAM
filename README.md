...
<table>
  ...
  <tr>
    <td><b>최요섭</b></td>
    <td>지난 프로젝트는 많이 아쉬웠지만, 이번 팀 프로젝트를 통해 팀원들의 도움으로 부족한 부분을 많이 보완할 수 있었습니다. 특히 실제로 눈에 보이는 웹 개발을 직접 해보며 더 큰 성취감을 느꼈습니다.</td>
  </tr>
  <tr>
    <td><b>김재현</b></td>
  ...
  <tr>
    <td><b>윤권</b></td>
    <td> 100시간 이상을 파인튜닝한 모델의 성능을 목표치까지 향상되지 않아 사용하지 못해서 아쉬웠지만 클라우드에 배포하는 과정까지 경험할 수 있어서 좋았습니다.</td>
  </tr>
</table>
